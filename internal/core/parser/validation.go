...
func validationFunctions() map[string]function.Function {
	return map[string]function.Function{
		"length":     validationLengthFunction(),
...
func validationLengthFunction() function.Function {
	return function.New(&function.Spec{
		...
		Impl: func(args []cty.Value, _ cty.Type) (cty.Value, error) {
			...
			if value.Type().Equals(cty.String) {
				return stdlib.StrlenFunc.Call([]cty.Value{value})
			}
			return stdlib.LengthFunc.Call([]cty.Value{value})
		},
	})
}
