<p align="right"><strong>English</strong> | <a href="openrc.zh.md">简体中文</a></p>
...
Raw scripts must advertise reload through `extra_started_commands` and should
set `description_reload`. The provider checks OpenRC's described commands
before invoking reload, because OpenRC can otherwise return success for an
undefined fallback.
